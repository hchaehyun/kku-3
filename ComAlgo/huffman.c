...
// The main function that builds a Huffman Tree from array of frequency of characters
...
// The main function that builds a Huffman Tree and print codes by travers
...
int main() {
    char arr[] = {'k', 'i', 'm', 'c', 'h', 'a', 'n', 'g'};
    int freq[] = {5, 9, 12, 13, 16, 45, 12, 13};
